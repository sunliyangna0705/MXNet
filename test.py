...
parser.add_argument("--model_dir", type=str, default="/data0/sunlina/models/DuSR-mask-learning-Node11/models/19Dec_035237pm_0.8acc_2000ep_10T_10S",
                    help='path to model and log files')
parser.add_argument("--data_path", type=str, default="/data0/sunlina/data/Admm-data/test", help='path to testing data')
parser.add_argument("--mask_dir_tst", type=str, default="/data0/sunlina/data/Admm-data/mask_40/mask0.4.mat", help='test mask data')
...
parser.add_argument('--save_img_dir', default='/data0/sunlina/models/DuSR-mask-learning/test_imgs/', help='saving temp images')
parser.add_argument("--save_path", type=str, default="/data0/sunlina/models/DuSR-mask-learning/test_result/imgs", help='path to save data')
